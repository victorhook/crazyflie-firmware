...
#define CRTP_TRANSPORT_MTU CRTP_MAX_DATA_SIZE

#if CRTP_TRANSPORT_MTU > CPX_MAX_PAYLOAD_SIZE
    #pragma warn "CRTP MTU bigger than defined by CPX"
#endif

void crtpTransportInit();

// Interface used by the router
void crtpTransportSend(const CPXPacket_t* packet);
